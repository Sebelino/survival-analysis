...
follow-up.
* The curve for the treatment group (`hormon=1`) is consistently above the
...
* There seem to be a sudden drop in survival for the treatment group at around
...
the proportional hazards assumption holds for the hormonal treatment
variable.
Meaning, there is no significant evidence that the effect of hormonal
treatment changes over time.
Hence, the proprtional hazards assumption appears to be satisfied,
