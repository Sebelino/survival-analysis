...
* \(\beta_{\text{Unk}} \approx 0.94\) is the log-hazard ratio for the "Unknown" stage. The hazard ratio is
...
* \(\beta_{\text{Reg}} \approx 0.80\) is the log-hazard ratio for the "Regional" stage. The hazard ratio is
\(\exp(\beta_{\text{Reg}}) \approx 2.23\).
Meaning, the hazard for colon cancer patients in the "Regional" stage
is 2.23 times that of patients in the "Localised" stage.
* \(\beta_{\text{Dis}} \approx 2.22\) is the log-hazard ratio for the "Distant" stage. The hazard ratio is
\(\exp(\beta_{\text{Dis}}) \approx 9.20\).
Meaning, the hazard for colon cancer patients in the "Distant" stage
is 9.20 times that of patients in the "Localised" stage at time \(t=0\).
* \(\beta_{tt} \approx -0.12\) is the per-year change in the log-hazard ratio for "Distant" vs. "Localised".
The corresponding change in hazard ratio is
